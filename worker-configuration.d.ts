/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dde2862d43462bc5923f7fc026a8f518)
// Runtime types generated with workerd@1.20260923.1 2025-09-01
interface __BaseEnv_Env {
	AI: Ai;
	VOTE_REMINDER_AFTER: "12 hours";
	VOTE_CLOSE_AFTER: "12 hours";
	TRIP_ROOM: DurableObjectNamespace<import("./src/index").TripRoom>;
	ITINERARY_WORKFLOW: Workflow<Parameters<import("./src/index").ItineraryWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TripRoom";
	}
